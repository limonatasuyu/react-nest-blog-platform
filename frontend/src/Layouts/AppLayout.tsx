...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  async function handleSeeNotification(notificationIds: string[]) {
    ...
    await fetch(`${"react-nest-blog-platform-production.up.railway.app"}notification/see`, {
      headers: {
  ...
  function handleLookAtNotifications() {
    ...
    const token = window.sessionStorage.getItem("access_token");
    fetch(`${"react-nest-blog-platform-production.up.railway.app"}notification/look`, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-type": "application/json",
      },
  ...
  useEffect(() => {
    const token = window.sessionStorage.getItem("access_token");
    fetch(`${"react-nest-blog-platform-production.up.railway.app"}notification`, {
                  ...
                  >
                    <Avatar
                      src={
                        ...
                        `${"react-nest-blog-platform-production.up.railway.app"}image/${notification.lastPerson.profilePictureId}`
                      }
                    ...
                    {notification.thumbnailId && (
                      <Box
                        ...
                        src={
                          notification.thumbnailId
                            ? `${"react-nest-blog-platform-production.up.railway.app"}image/${notification.thumbnailId}`
